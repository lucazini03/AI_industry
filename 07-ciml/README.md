---
title: AI in the Industry (Constraints and Machine Learning)
...
This tutorial in particular tackles topic of enforcing constraint satisfaction in Machine Learning, showing how explicit information or restrictions (needed for safety or regulation compliance) can taken into account in ML via few example mechanism (Lagrangian terms and Universal Differential Equations).
...
```sh
git clone https://github.com/a3i-2025-2026/07-ciml.git
```
